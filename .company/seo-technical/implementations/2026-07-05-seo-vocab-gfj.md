...
- 既存のmeta verification（bxECX...）とGA4（G-HP8686808M）は**clublinebangkok@gmail.com** に紐づく（オーナー確認済み 2026-07-05）。GSCは現在2アカウント体制（clublinebangkok=旧・meta認証 / オーナー個人=新・HTMLファイル認証）
